...
## 速览
**TLDR**：本研究提出AnnotateAnyCell，一个开源的半监督AI框架，结合主动对比学习和人机交互策略，用于高效标注和分类数字病理切片中的细胞，实现病理AI的可扩展应用。 \
**Motivation**：手工标注病理全切片图像耗时巨大，制约了病理AI的训练与部署。 \
**Method**：框架整合Cellpose分割、UMAP可视化与对比学习伪标签传播，通过人机迭代优化细胞标注。 \
**Result**：在犬尿路上皮癌样本中，标注时间减少25%，分类准确率达96%以上，验证了系统的高效与准确性。 \
**Conclusion**：该框架能在保持专家级准确度的同时显著减少标注负担，提升病理AI在资源受限环境中的可行性。
