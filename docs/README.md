...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-25 22:28:50 UTC<br>状态：成功</p>
</section>
...
<p>速读：《SpaFactor: Lightweight Spatial Context-Aware Gene Program Modeling for Histology-to-Transcriptomics Inference》（7.0/10）, 《Cross-Modal Contrastive Learning from Histopathology and CT for Automated Renal Cell Carcinoma Grading》（6.0/10）, 《A Multimodal Dataset for Survival Prediction in Resected Pancreatic Ductal Adenocarcinoma》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="SpaFactor: Lightweight Spatial Context-Aware Gene Program Modeling for Histology-to-Transcriptomics Inference">SpaFactor: Lightweight Spatial Context-Aware Gene Program Modeling for Histology-to-Transcriptomics Inference</span></li><li><span class="dpr-home-dashboard-paper-title" title="Cross-Modal Contrastive Learning from Histopathology and CT for Automated Renal Cell Carcinoma Grading">Cross-Modal Contrastive Learning from Histopathology and CT for Automated Renal Cell Carcinoma Grading</span></li><li><span class="dpr-home-dashboard-paper-title" title="A Multimodal Dataset for Survival Prediction in Resected Pancreatic Ductal Adenocarcinoma">A Multimodal Dataset for Survival Prediction in Resected Pancreatic Ductal Adenocarcinoma</span></li></ul>
  </div>
