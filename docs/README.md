...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-23 20:38:58 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Pheno-MYCN maps the morphological footprint of MYCN amplification in paediatric neuroblastoma》（9.0/10）</p>
<p>速读：《An AI-assisted platform for quantitative histopathological analysis in interstitial lung disease》（7.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Pheno-MYCN maps the morphological footprint of MYCN amplification in paediatric neuroblastoma">Pheno-MYCN maps the morphological footprint of MYCN amplification in paediatric neuroblastoma</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="An AI-assisted platform for quantitative histopathological analysis in interstitial lung disease">An AI-assisted platform for quantitative histopathological analysis in interstitial lung disease</span></li></ul>
  </div>
