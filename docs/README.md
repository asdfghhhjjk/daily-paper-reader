...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-24 21:02:13 UTC<br>状态：成功</p>
</section>
...
<p>精读：《CellPath-Bench: A Multidimensional Benchmark for Whole-Slide Cellular Representations in Pathology Foundation Models》（9.0/10）, 《Pheno-MYCN maps the morphological footprint of MYCN amplification in paediatric neuroblastoma》（9.0/10）</p>
<p>速读：《Concept-based explanation of gene expression prediction from H&amp;E images》（7.0/10）, 《Interactive Whole Slide Images for RL-based Tumour Segmentation》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="CellPath-Bench: A Multidimensional Benchmark for Whole-Slide Cellular Representations in Pathology Foundation Models">CellPath-Bench: A Multidimensional Benchmark for Whole-Slide Cellular Representations in Pathology Foundation Models</span></li><li><span class="dpr-home-dashboard-paper-title" title="Pheno-MYCN maps the morphological footprint of MYCN amplification in paediatric neuroblastoma">Pheno-MYCN maps the morphological footprint of MYCN amplification in paediatric neuroblastoma</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Concept-based explanation of gene expression prediction from H&amp;E images">Concept-based explanation of gene expression prediction from H&amp;E images</span></li><li><span class="dpr-home-dashboard-paper-title" title="Interactive Whole Slide Images for RL-based Tumour Segmentation">Interactive Whole Slide Images for RL-based Tumour Segmentation</span></li></ul>
  </div>
