...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-22 20:25:18 UTC<br>状态：成功</p>
</section>
...
<p>速读：《Pheno-MYCN maps the morphological footprint of MYCN amplification in paediatric neuroblastoma》（7.0/10）, 《Test-Time Instance Selection for Improved Whole Slide Image Analysis》（6.0/10）, 《Decomposing Whole Slide Image Report Generation with Graph-Constrained Multiple Instance Learning Workflows》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Pheno-MYCN maps the morphological footprint of MYCN amplification in paediatric neuroblastoma">Pheno-MYCN maps the morphological footprint of MYCN amplification in paediatric neuroblastoma</span></li><li><span class="dpr-home-dashboard-paper-title" title="Test-Time Instance Selection for Improved Whole Slide Image Analysis">Test-Time Instance Selection for Improved Whole Slide Image Analysis</span></li><li><span class="dpr-home-dashboard-paper-title" title="Decomposing Whole Slide Image Report Generation with Graph-Constrained Multiple Instance Learning Workflows">Decomposing Whole Slide Image Report Generation with Graph-Constrained Multiple Instance Learning Workflows</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">cell-path <strong>3</strong></span></div>
</section>
</div>
