...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-01 23:04:57 UTC<br>状态：成功</p>
</section>
...
<p>速读：《Whole-Slide Image Analysis under Realistic Few-Shot Annotation Protocols》（7.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Whole-Slide Image Analysis under Realistic Few-Shot Annotation Protocols">Whole-Slide Image Analysis under Realistic Few-Shot Annotation Protocols</span></li></ul>
  </div>
