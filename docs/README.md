...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-21 23:10:11 UTC<br>状态：成功</p>
</section>
...
<p>精读：《End-to-End Cell Detection via Instance-aware Graph Modeling》（9.0/10）</p>
<p>速读：《Learning Where to Focus: Self-Supervised Multi-Scale ViTs for Histopathology》（7.0/10）, 《Hybrid quantum-classical attention for histopathology-based molecular profiling in data-limited cancers》（7.0/10）, 《Sharing standardized image-derived data in computational pathology using DICOM》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="End-to-End Cell Detection via Instance-aware Graph Modeling">End-to-End Cell Detection via Instance-aware Graph Modeling</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Learning Where to Focus: Self-Supervised Multi-Scale ViTs for Histopathology">Learning Where to Focus: Self-Supervised Multi-Scale ViTs for Histopathology</span></li><li><span class="dpr-home-dashboard-paper-title" title="Hybrid quantum-classical attention for histopathology-based molecular profiling in data-limited cancers">Hybrid quantum-classical attention for histopathology-based molecular profiling in data-limited cancers</span></li><li><span class="dpr-home-dashboard-paper-title" title="Sharing standardized image-derived data in computational pathology using DICOM">Sharing standardized image-derived data in computational pathology using DICOM</span></li></ul>
  </div>
