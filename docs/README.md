...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-22 22:33:21 UTC<br>状态：成功</p>
</section>
...
<p>今日精读一篇9.0分的有丝分裂图像分析新方法MiTHras，并速读复杂网络图元指纹研究。</p>
<p>最值得关注：MiTHras用层次半监督对比掩码自编码器提升有丝分裂检测，图元方法为复杂网络提供结构指纹。</p>
<p>下步建议：关注AI病理可深挖半监督对比学习在医学图像中的落地，关注网络科学可探索图元指纹的应用边界。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="MiTHras: Task-specific Hierarchical Semi-supervised Contrastive Masked Autoencoder for Mitotic Figure Analysis">MiTHras: Task-specific Hierarchical Semi-supervised Contrastive Masked Autoencoder for Mitotic Figure Analysis</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Graphlets as structural fingerprints of complex networks">Graphlets as structural fingerprints of complex networks</span></li></ul>
  </div>
